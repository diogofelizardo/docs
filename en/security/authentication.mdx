...
<AccordionGroup>
  ...
  <Accordion title="Monitor token usage">
    Use the [Consumption Dashboard](/en/monitoring/consumption) to track which tokens are being used and how often. Unusual patterns may indicate unauthorized access.
  </Accordion>
</AccordionGroup>
