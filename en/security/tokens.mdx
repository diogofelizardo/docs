...
Tokens are created during the [publishing workflow](/en/platform/publishing) or from the project settings:
...
Tokens can also be managed programmatically via the REST API. See the [Tokens API Reference](/en/api-reference/tokens) for endpoints.
