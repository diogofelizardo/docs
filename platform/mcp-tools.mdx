...
<Steps>
  <Step title="Select a view">
    Every tool must be linked to an [Agent View](/platform/agent-views). Select or create a view first.
  </Step>
...
See [Data Masking](/security/data-masking) for detailed policy configuration.
